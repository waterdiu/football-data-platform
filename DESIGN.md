...
- `team_staff` 用于球队教练/工作人员档案。当前已补 32 支球队主教练数据，来源为对应 FIFA 官方文章，发布到 `data/public/team-staff.json`、`api/worldcup/2026/core/team-staff.json` 和 predictor API。
...
- 已补齐：已有官方 26 人名单的 9 支球队 roster / 234 名球员；32 支球队主教练数据，通过 `data/patches/world_cup_2026_team_staff.manual.json` 和 `scripts/import_world_cup_team_staff_from_manual_patch.py` 进入 `person_team_staff_master.json`
