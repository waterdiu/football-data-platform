...
- Player external facts are now partially filled from dcaribou Transfermarkt via Reep `key_transfermarkt` plus audited dcaribou activity Transfermarkt IDs: 221 external-fact rows, 211 with club, 221 with DOB/age, and 220 with display `impact_proxy_score`.
