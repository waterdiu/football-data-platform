...
- 当前导入结果：208 条映射，204 条已唯一解析，0 条 ambiguous，4 条 missing；10 条同名/拼写差异已通过 `data/patches/person_id_map.manual.json` 人工审查消歧，2 条通过 Reep `names.csv` 别名表解析，未解决清单见 `reports/person_id_map_unresolved_report.json`。
