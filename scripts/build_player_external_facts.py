    ...
    for player in players:
        ...
        fact = {
            ...
            "source_refs": {
                ...
                "person_id_map_confidence": id_row.get("confidence") if isinstance(id_row, dict) else None,
                "person_id_map_resolution_method": id_row.get("resolution_method") if isinstance(id_row, dict) else None,
